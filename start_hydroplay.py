...
class HydroPlayLauncher:
    ...
    def start_ai_bridge(self):
        ...
        cmd = [
            "bash", "-c", 
            f"cd {ai_dir} && source venv/bin/activate && python main.py"
        ]
    ...
    def open_browser(self):
        """Open browser to HydroPlay UI"""
        print("🚀 Opening HydroPlay in browser...")
        time.sleep(1)
        webbrowser.open("http://localhost:8000")
    
    def start_all(self):
        """Start all HydroPlay services"""
        print("🚰 HydroPlay Unified Launcher")
        print("=" * 40)
